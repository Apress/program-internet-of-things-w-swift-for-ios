...
class FirstViewController: UITableViewController, WCSessionDelegate {
    ...
    override func viewDidLoad() {
        ...
        NSNotificationCenter.defaultCenter().addObserverForName("LocationUpdateNotification", object: nil, queue: NSOperationQueue.mainQueue()) { (notif: NSNotification) -> Void in
            //
